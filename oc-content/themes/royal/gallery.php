...
<div class="container">
    <div class="ari">
        <h2><?php _e("Premium Listings", 'royal') ; ?></h2> </div>
                ...
                <div class="info">
                    <div class="row">
                        <div class="col-md-12 price">
                            ...
                            <?php if( osc_price_enabled_at_items() && osc_item_category_price_enabled(osc_premium_category_id()) ) { ?> <?php echo osc_format_price(osc_premium_price(), osc_premium_currency_symbol()); ?><?php } ?></h5> 
                        </div>
